<form action="<?= base_url('user/createHama'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row bg-light border tab-pane active" id="head">
                    <div class="form-row mx-2 my-2" style="">
                        <div class="col-6">
                            ...
                            <input type="text" class="input form-control" name="nama_hama">
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input type="file" class="input form-control" name="gambar_hama">
                        </div>
